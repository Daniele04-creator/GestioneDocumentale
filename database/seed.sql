...
VALUES
  ('tag-requisiti', 'Requisiti'),
  ('tag-architettura', 'Architettura'),
  ('tag-tecnico', 'Tecnico'),
  ('tag-api', 'API'),
  ('tag-ui', 'UI'),
  ('tag-qa', 'QA'),
  ('tag-validazione', 'Validazione'),
  ('tag-test', 'Test'),
...
VALUES
  ('DOC-001', 'tag-requisiti'),
  ('DOC-001', 'tag-tecnico'),
  ('DOC-002', 'tag-architettura'),
  ('DOC-002', 'tag-tecnico'),
  ('DOC-003', 'tag-rischi'),
  ('DOC-003', 'tag-requisiti'),
  ('DOC-004', 'tag-checklist'),
  ('DOC-004', 'tag-validazione'),
  ('DOC-005', 'tag-wbs'),
  ('DOC-005', 'tag-tecnico'),
  ('DOC-006', 'tag-api'),
  ('DOC-006', 'tag-tecnico'),
  ('DOC-006', 'tag-architettura'),
  ('DOC-006', 'tag-qa'),
  ('DOC-007', 'tag-requisiti'),
  ('DOC-007', 'tag-tecnico'),
  ('DOC-008', 'tag-frontend'),
  ('DOC-008', 'tag-sintesi'),
  ('DOC-009', 'tag-ui'),
  ('DOC-009', 'tag-frontend'),
  ('DOC-010', 'tag-ui'),
  ('DOC-010', 'tag-checklist'),
  ('DOC-011', 'tag-api'),
  ('DOC-011', 'tag-frontend'),
  ('DOC-012', 'tag-ui'),
  ('DOC-012', 'tag-frontend'),
  ('DOC-013', 'tag-ui'),
  ('DOC-013', 'tag-frontend'),
  ('DOC-014', 'tag-frontend'),
  ('DOC-014', 'tag-validazione'),
  ('DOC-015', 'tag-validazione'),
  ('DOC-015', 'tag-qa'),
  ('DOC-016', 'tag-download'),
  ('DOC-016', 'tag-test'),
  ('DOC-017', 'tag-postman'),
  ('DOC-017', 'tag-test'),
  ('DOC-017', 'tag-checklist'),
  ('DOC-018', 'tag-tecnico'),
  ('DOC-018', 'tag-validazione'),
  ('DOC-019', 'tag-sintesi'),
  ('DOC-019', 'tag-validazione')
